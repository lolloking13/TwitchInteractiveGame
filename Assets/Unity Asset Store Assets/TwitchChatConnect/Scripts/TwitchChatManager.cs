...
public class TwitchChatManager : MonoBehaviour
{
        ...
        TwitchChatClient.instance.Init(() =>
            {
                ...
                TwitchChatClient.instance.onChatCommandReceived += AnalizeCommand;
    ...
    private void ShowCommand(TwitchChatCommand chatCommand)
    {
        ...
        TwitchChatClient.instance.SendChatMessage($"Ciao {chatCommand.User.DisplayName}! Il tuo comando e' stato rilevato!");
    ...
    private void AnalizeCommand(TwitchChatCommand chatCommand) {
        experienceManager.AnalizeCommand(chatCommand);
    }
}