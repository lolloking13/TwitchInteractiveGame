...
namespace TwitchChatConnect.Client
{
    public class TwitchChatClient : MonoBehaviour
    {
        ...
        {
            TwitchConnectConfig tcc = new TwitchConnectConfig(
                PlayerPrefs.GetString("UserName"),
                PlayerPrefs.GetString("UserToken"),
                PlayerPrefs.GetString("UserChannelName")
                );

            Debug.Log("Loaded User Config:" + " Name: " + tcc.Username + " Token: " + tcc.UserToken + " Channel: " + tcc.ChannelName);

            Init(tcc, onSuccess, onError);
        }
